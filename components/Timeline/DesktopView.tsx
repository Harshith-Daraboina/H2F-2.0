...
export default function DesktopView() {
  ...
  return (
    ...
    >
      ...
      <div className="z-[2] w-full max-w-7xl mx-auto text-white mt-28 mb-12">
        <motion.h1
          style={{ x: headingX }}
          ...
          className="font-anton relative left-8 z-[2] w-full text-[3rem] uppercase leading-[1] text-white sm:left-20 md:text-[90px]"
        >
          TimeLine
          <motion.span
        ...
        <DesktopAnimate>
          <div className="z-10 h-fit max-w-[calc(100vw-160px)] place-self-center overflow-hidden">
            <div
              ...
              className="flex items-center text-center transition-transform duration-500 ease-in-out opacity-100 translate-x-0"
            >
          ...
          <div className="relative h-fit w-full max-w-4xl place-self-center">
            ...
            >
              <Image
                ...
                height={360}
                alt="rocket image"
                className="z-20 scale-[30%] xl:scale-[60%]"
              />
            </div>
              ...
              <div className="absolute top-[26px] z-10 flex w-full justify-between">
                {timelines.map((timeline) => (
                  ...
                  >
                    ...
                    <p className="text-center text-[#a6dff9] font-bold">{timeline.heading}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="max-w-[calc(100vw-160px)] place-self-center overflow-hidden">
            <div
              ...
              className="flex h-fit items-center pt-8 text-center transition-transform duration-500 ease-in-out opacity-0 translate-x-1/2"
            >
              {timelines.map((timeline, index) => {
                if (index % 2 != 0) return null;
                return (
